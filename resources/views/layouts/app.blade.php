...
<head>
    ...
    <title>GiziMart - Dashboard</title>
    ...
    <style>
        ...
        /* Custom tosca background for sidebar */
        .bg-tosca {
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-tosca sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
                ...
                <div class="sidebar-brand-text mx-3">GiziMart</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="pembayaranMenu" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Akses:</h6>
                        <a class="collapse-item" href="{{ url('#') }}">Lihat Pembayaran</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Ulasan -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#ulasanMenu" aria-expanded="true" aria-controls="ulasanMenu">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="{{ route('profile.edit') }}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>Profile Update
                                </a>
